...
set utils_file "$::env(WORKROOT)/scripts/vivado/utils.tcl"
if {[file exists $utils_file]} {
    source $utils_file
} elseif {[file exists "./scripts/vivado/utils.tcl"]} {
    source "./scripts/vivado/utils.tcl"
}
...
source "$WORKROOT/scripts/vivado/create_project.tcl"
source "$WORKROOT/scripts/vivado/run_synthesis.tcl"
source "$WORKROOT/scripts/vivado/run_impl.tcl"
