...
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "*A9*#0" && jtag_cable_name =~ "Digilent Zybo Z7 210351B04BB2A" && jtag_device_ctx=="jsn-Zybo Z7-210351B04BB2A-4ba00477-0"}
rst -processor
dow /home/george/repos/aimbot/lib/tpg_vdma_vitis/app_tpg_vdma_demo/build/app_tpg_vdma_demo.elf
bpadd main
con
