...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { CAM_SIOC }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { CAM_SIOD }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
...
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports { CAM_HREF  }]; #IO_L13P_T2_MRCC_13 Sch=jb_p[3]        
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports { CAM_VSYNC }]; #IO_L13N_T2_MRCC_13 Sch=jb_n[3]        
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33     } [get_ports { CAM_PCLK  }]; #IO_L22P_T3_13 Sch=jb_p[4]             
...
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { CAM_DATA[1] }]; #IO_L10N_T1_34 Sch=jc_n[1]		     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { CAM_DATA[2] }]; #IO_L1P_T0_34 Sch=jc_p[2]              
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { CAM_DATA[3] }]; #IO_L1N_T0_34 Sch=jc_n[2]              
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { CAM_DATA[4] }]; #IO_L8P_T1_34 Sch=jc_p[3]              
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { CAM_DATA[5] }]; #IO_L8N_T1_34 Sch=jc_n[3]              
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { CAM_DATA[6] }]; #IO_L2P_T0_34 Sch=jc_p[4]              
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33     } [get_ports { CAM_DATA[7] }]; #IO_L2N_T0_34 Sch=jc_n[4]              
